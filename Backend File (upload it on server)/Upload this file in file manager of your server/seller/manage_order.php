...
?>
        ...
        <div class="card mrg_bottom">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title">Manage Orders</div>
            </div>
 ...
 // INSERT INTO `tbl_order`(`o_id`, `u_id`, `offer_id`, `total_amount`, `dis_amount`, `pay_amount`, `o_address`, `o_date`, `o_status`)	 
                ...
                <tr>
					...
					<td><?php echo get_vendor_info($users_row['id'],'username'); ?> </td>
                   ...
                   <td><a href="view_order.php?o_id=<?php echo $users_row['o_id'];?>" class="btn btn-primary">View</a>
