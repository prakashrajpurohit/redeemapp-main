	...
	if(isset($_POST['submit']))
	{
		if($_FILES['image']['name']!="")
		 {		
				...
				$img_res=mysqli_query($mysqli,'SELECT * FROM tbl_vendor WHERE id='.$_SESSION['id'].'');
			    ...
			    if($img_res_row['image']!="")
		        {
				   ...
				   $tpath1='images/'.$image;
					...
					$channel_edit=Update('tbl_vendor', $data, "WHERE id = '".$_SESSION['id']."'"); 
        ...
        <div class="card">
		  <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title">Vendor Profile</div>
            </div>
          </div>
