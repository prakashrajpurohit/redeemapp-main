     ...
     {   
       ...
       'o_price'  =>  $_POST['o_price'],		
			...
			if ($user_edit > 0){
				...
				$_SESSION['msg']="11";
				header("Location:add_auctions.php?o_id=".$_POST['o_id']);
				exit;
			} 	
 }
        ...
        <div class="card">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title"><?php if(isset($_GET['o_id'])){?>Edit<?php }else{?>Add<?php }?> Auctions</div>
            </div>
          </div>
              ...
              <div class="section">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                    <label class="col-md-3 control-label">Starting Bid:-</label>
                    <div class="col-md-6">
                      <input type="text" name="o_min" id="o_min" value="<?php if(isset($_GET['o_id'])){echo $user_row['o_min'];}?>" class="form-control">
                    </div>
                  </div>
                    <div class="form-group">
                    <label class="col-md-3 control-label">Maximum Bid:-</label>
                    <div class="col-md-6">
                      <input type="text" name="o_max" id="o_max" value="<?php if(isset($_GET['o_id'])){echo $user_row['o_max'];}?>" class="form-control">
                    </div>
                  </div>
                    <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-9 col-md-offset-3">
                      <button type="submit" name="submit" class="btn btn-primary">Save Auction</button>
                    </div>
                  </div>
                </div>
              </div>
