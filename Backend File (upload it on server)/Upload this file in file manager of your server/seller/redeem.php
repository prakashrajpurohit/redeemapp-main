<?php include('includes/header.php'); 
	...
	if(isset($_POST['user_search']))
	 ...
	 else
	 {
						 ...
						 WHERE tbl_offers.id like '$id' AND o_type = '3'
        ...
        <div class="card mrg_bottom">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title">Manage Redeem Items</div>
            </div>
            <div class="col-md-7 col-xs-12">              
                  <div class="search_list">
                    ...
                    <div class="add_btn_primary"> <a href="add_redeem.php?add">Add Item</a> </div>
                  </div>
 ...
 //INSERT INTO `tbl_offers`(`o_id`, `o_name`, `o_image`, `o_desc`, `o_date`, `o_stime`, `o_etime`, `o_status`) 
                ...
                <tr>
		           ...
		           <td>
		              ...
		              <a href="redeem.php?status_deactive_id=<?php echo $users_row['o_id'];?>" title="Change Status"><span class="badge badge-success badge-icon"><i class="fa fa-check" aria-hidden="true"></i><span>Show on App</span></span></a>

		              <?php }else{?>
		              <a href="redeem.php?status_active_id=<?php echo $users_row['o_id'];?>" title="Change Status"><span class="badge badge-danger badge-icon"><i class="fa fa-check" aria-hidden="true"></i><span>Don't Show on App</span></span></a>
		              <?php }?>
              		</td>
                   <td><a href="add_redeem.php?o_id=<?php echo $users_row['o_id'];?>" class="btn btn-primary">Edit</a>
                    <a href="redeem.php?o_id=<?php echo $users_row['o_id'];?>" onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-default">Delete</a></td>
                </tr>
               <?php
