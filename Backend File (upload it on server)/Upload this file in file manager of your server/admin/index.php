      ...
      <div class="app-body">
        <div class="app-block">
          <div class="app-form login-form">
            ...
            <div class="form-header">
              <div class="app-brand">Admin Panel</div>
            </div>
            ...
            <form action="login_db.php" method="post">
              ...
              <div class="input-group"> <span class="input-group-addon" id="basic-addon1"> <i class="fa fa-user" aria-hidden="true"></i></span>
                <input type="text" name="username" id="username" class="form-control" placeholder="Login ID" aria-describedby="basic-addon1">
              </div>
              <div class="input-group"> <span class="input-group-addon" id="basic-addon2"> <i class="fa fa-lock" aria-hidden="true"></i></span>
                <input type="password" name="password" id="password" class="form-control" placeholder="Login Password" aria-describedby="basic-addon2">
              </div>
