        ...
        <div class="card">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title"><?php if(isset($_GET['o_id'])){?>Edit<?php }else{?>Add<?php }?> Redeem Item</div>
            </div>
          </div>
              ...
              <div class="section">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="form-group">
                    <label class="col-md-3 control-label">Cost per redeem:-</label>
                    <div class="col-md-6">
                      <input type="text" placeholder="coins to be deducted per redeem " name="o_amount" id="o_amount" value="<?php if(isset($_GET['o_id'])){echo $user_row['o_amount'];}?>" class="form-control">
                    </div>
                  </div>
                    <div class="form-group">
