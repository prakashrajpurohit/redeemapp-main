      ...
      <div class="col-md-12">
        <div class="card">
          <div class="page_title_block">
            ...
            <div class="page_title">Winners are shown after raffle is ended!</div>
		  	...
		  	?>
		  	 ...
		  	 <div class="col-md-4" >
                    ...
                    <div class="form-group">
                        <label class="col-md-12 control-label"><b>Name :- </b><?php if(isset($_GET['o_id'])){echo $row1['name'];}?> </label>
                     </div>
                  
                    <div class="form-group">
                      <label class="col-md-12 control-label"><b>Email :-  </b> <?php if(isset($_GET['o_id'])){echo $row1['email'];}?></label>
                    </div>
                    <div class="form-group">
                      <label class="col-md-12 control-label"><b>Phone :-  </b> <?php if(isset($_GET['o_id'])){echo $row1['phone'];}?></label>
                    </div>
                  </div>
                 <table id='table'>   
                 ...
                 <div class="col-md-12 mrg-top">
                  <table id="t01" class="table table-striped table-bordered table-hover">
                     <tr id='tr'>
                         <th id='th'>Raffle Name</th>
                         <th id='th'>Raffle Image</th>
                         <th id='th'>Bid Date</th>
                         <th id='th'>Bid Value</th>
                         <th id='th'>Bid Amount</th>
                    </tr>
                <tr>
                    <td>
