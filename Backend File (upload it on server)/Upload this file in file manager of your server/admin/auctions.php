          ...
          <div class="page_title_block">
            ...
            <div class="col-md-7 col-xs-12">              
                  <div class="search_list">
                    ...
                    <div class="add_btn_primary"> <a href="../seller">Add Auctions from Seller Portal</a> </div>
                  </div>
 ...
 //INSERT INTO `tbl_offers`(`o_id`, `o_name`, `o_image`, `o_desc`, `o_date`, `o_stime`, `o_etime`, `o_status`) 
                ...
                <tr>
		           ...
		           <td>
		              ...
		              <a href="auctions.php?status_deactive_id=<?php echo $users_row['o_id'];?>" title="Change Status"><span class="badge badge-success badge-icon"><i class="fa fa-check" aria-hidden="true"></i><span>Show on App</span></span></a>

		              <?php }else{?>
		              <a href="auctions.php?status_active_id=<?php echo $users_row['o_id'];?>" title="Change Status"><span class="badge badge-danger badge-icon"><i class="fa fa-check" aria-hidden="true"></i><span>Don't Show on App</span></span></a>
		              <?php }?>
              		</td>
                   <td><a href="add_auction.php?o_id=<?php echo $users_row['o_id'];?>" class="btn btn-primary">Edit</a>
                    <a href="auctions.php?o_id=<?php echo $users_row['o_id'];?>" onclick="return confirm('Are you sure you want to delete this auction?');" class="btn btn-default">Delete</a></td>
                </tr>
               <?php
