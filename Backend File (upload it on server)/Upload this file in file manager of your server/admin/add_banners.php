        ...
        <div class="card">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title"><?php if(isset($_GET['o_id'])){?>Edit<?php }else{?>Add<?php }?>  Banner</div>
            </div>
          </div>
            ...
            <form action="" name="addedituser" method="post" class="form form-horizontal" enctype="multipart/form-data" >
              ...
              <div class="section">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input type="text" placeholder="enter the name of the banner "  name="o_name" id="o_name" value="<?php if(isset($_GET['o_id'])){echo $user_row['o_name'];}?>" class="form-control" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input type="text" name="o_link" placeholder="link to be opened after clicking "  id="o_link" value="<?php if(isset($_GET['o_id'])){echo $user_row['o_link'];}?>" class="form-control" >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input type="date" title="banner start date "  name="o_date" id="o_date" value="<?php if(isset($_GET['o_id'])){echo $user_row['o_date'];}?>" class="form-control">
                    </div>
                  </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">End Date :-</label>
                    <div class="col-md-6">
                      <input type="date" title="banner end date " name="o_edate" id="o_edate" value="<?php if(isset($_GET['o_id'])){echo $user_row['o_edate'];}?>" class="form-control">
                    </div>
                  </div>
                    ...
                    <div class="col-md-6">
                      <input type="time" title="banner start time " name="o_stime" id="o_stime" step="2" value="<?php if(isset($_GET['o_id'])){echo $user_row['o_stime'];}?>" class="form-control">
                    </div>
                  </div>
                    <div class="form-group">
                    <label class="col-md-3 control-label">End time :-</label>
                    <div class="col-md-6">
                      <input type="time" title="banner end time " name="o_etime" id="o_etime" step="2" value="<?php if(isset($_GET['o_id'])){echo $user_row['o_etime'];}?>" class="form-control">
                    </div>
                  </div>
