...
?>
        ...
        <div class="card mrg_bottom">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title">Manage Claims</div>
            </div>
 ...
 // INSERT INTO `tbl_order`(`o_id`, `u_id`, `offer_id`, `total_amount`, `dis_amount`, `pay_amount`, `o_address`, `o_date`, `o_status`)	 
                ...
                <tr>
                    ...
                    <td><?php echo $users_row['pay_amount'].' Coins';?></td>
		           <td>
                   ...
                   <td><a href="add_claim.php?o_id=<?php echo $users_row['o_id'];?>" class="btn btn-primary">Edit</a>
                    <a href="orders.php?o_id=<?php echo $users_row['o_id'];?>" onclick="return confirm('Are you sure you want to delete this Claim?');" class="btn btn-default">Delete</a></td>
                </tr>
               <?php
