        ...
        <div class="card mrg_bottom">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title">Manage Coin Spends</div>
            </div>
            ...
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                      <!--<a href="add_tickets.php?bd_id=<?php echo $users_row['bd_id'];?>" class="btn btn-primary">Edit</a>-->
                    <a href="tickets.php?bd_id=<?php echo $users_row['bd_id'];?>" onclick="return confirm('Are you sure you want to delete this bids?');" class="btn btn-default">Delete</a></td>
                </tr>
               <?php
