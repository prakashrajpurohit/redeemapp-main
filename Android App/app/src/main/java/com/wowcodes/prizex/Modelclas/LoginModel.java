...
public class LoginModel
{
    ...
    public void setJSON_DATA(ArrayList<Login_model_Inner> JSON_DATA) {
    ...
    public class Login_model_Inner {
        ...
        public String toString()
        {
            return "ClassPojo [msg = "+msg+", image = "+image+", wallet = "+wallet+", code = "+code+", refferal_code = "+refferal_code+", network = "+network+", password = "+password+", phone = "+phone+", success = "+success+", name = "+name+", id = "+id+", email = "+email+", status = "+status+"]";
        }
