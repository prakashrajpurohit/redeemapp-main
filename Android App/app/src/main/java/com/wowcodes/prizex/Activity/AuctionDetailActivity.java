...
public class AuctionDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        savePref = new SavePref(AuctionDetailActivity.this);
        ...
        txtBids.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(AuctionDetailActivity.this, AllBidderActivity.class);
                i.putExtra("o_id", oId);
                startActivity(i);
            }
        });
            ...
            public void onClick(View view) {
                try {
                    if (!edForgotNumbid.getText().toString().equalsIgnoreCase("") && !edRange1.getText().toString().equalsIgnoreCase("") && !edRange2.getText().toString().equalsIgnoreCase("")) {
                        Toast.makeText(AuctionDetailActivity.this, "Please Add only one value at a time...", Toast.LENGTH_SHORT).show();
                    } else {
                        if (edForgotNumbid.getText().toString().equalsIgnoreCase("")) {
                            if (edRange1.getText().toString().equalsIgnoreCase("") || edRange2.getText().toString().equalsIgnoreCase("")) {
                                Toast.makeText(AuctionDetailActivity.this, "Please Enter some Bid Value", Toast.LENGTH_SHORT).show();
                                ...
                                if (Double.parseDouble(edRange1.getText().toString()) >= Double.parseDouble(edRange2.getText().toString())) {
                                    Toast.makeText(AuctionDetailActivity.this, "Please add Bid value in min to max", Toast.LENGTH_SHORT).show();
                                } else {
                                    ...
                                    ok.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            ...
                                            if (Integer.valueOf(totalWallet) >= Integer.valueOf(oAmount)) {
                                                ...
                                                Toast.makeText(AuctionDetailActivity.this, "Insufficient Coins,Please Add Some Coins to participate in this Auction", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
                                    dialog.show();
                    ...
                    Toast.makeText(AuctionDetailActivity.this, "Something Went Wrong!!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        txtYourr.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(AuctionDetailActivity.this, AllUserBidderActivity.class);
                i.putExtra("o_id", oId);
                startActivity(i);
            }
        });
        ...
        try {
            callofferApi().enqueue(new Callback<AllBidder>() {
                ...
                public void onResponse(Call<AllBidder> call, retrofit2.Response<AllBidder> response) {
                    ...
                    try {
                        Glide.with(AuctionDetailActivity.this)
            ...
            calladdbidApi().enqueue(new Callback<SuccessModel>() {
                ...
                public void onResponse(Call<SuccessModel> call, retrofit2.Response<SuccessModel> response) {
                    ...
                    try {
                        ...
                        Toast.makeText(AuctionDetailActivity.this, "" + arrayList.get(0).getMsg(), Toast.LENGTH_SHORT).show();


                        if (arrayList.get(0).getSuccess().equalsIgnoreCase("1")) {
                            Intent i = new Intent(AuctionDetailActivity.this, MainActivity.class);
                            startActivity(i);
